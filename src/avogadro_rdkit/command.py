...
Vendored copy of `avogadro.command` from avogadrolibs. The module ships in the
`avogadro` package from Avogadro 2.1 onwards (October 2026); once that release
is the minimum supported version this file can be deleted and the imports
changed to `from avogadro.command import report_progress`.
"""
import json
import os
